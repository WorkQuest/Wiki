    ...
    <div class="footer__body">
      ...
      >
        <div class="footer__left">
          ...
          >
            <img
              :src="require('assets/img/logo_gray.svg')"
              alt="Logo"
            >
            <span>WorkQuest</span>
          </div>
...
export default {
  ...
  computed: {
    ...
    companyLinks() {
      return [
        { title: this.$t('footer.company.wqWiki'), path: COMPANY.WIKI },
    ...
    DeFiLinks() {
      return {
        firstColumn: [
          { title: this.$t('footer.DeFi.retirement'), path: DeFi.RETIREMENT },
          { title: this.$t('footer.DeFi.referral'), path: DeFi.REFERRAL },
          { title: this.$t('footer.DeFi.P2P'), path: DeFi.P2P },
          { title: this.$t('footer.DeFi.savingsProduct'), path: DeFi.SAVINGS },
          { title: this.$t('footer.DeFi.lending'), path: DeFi.LENDING },
        ],
        secondColumn: [
          { title: this.$t('meta.liquidityMining'), path: SERVICES.MINING },
          { title: this.$t('footer.DeFi.wqBridge'), path: SERVICES.BRIDGE },
          { title: this.$t('footer.DeFi.staking'), path: SERVICES.STAKING },
          { title: this.$t('footer.DeFi.wqDAO'), path: SERVICES.DAO },
        ],
      };
    },
    socialList() {
...
.footer {
  ...
  .links {
    ...
    &__store {
      ...
      height: 56px;
      &_app-store {
        background-image: url('~/assets/img/app_store_button.svg');
      }
      &_play-market {
        background-image: url('~/assets/img/play_market_button.svg');
      }
    }
    &__social {
      width: 40px;
